        ...
        <div class="widget-content" >
          ...
          <?php
            if(isset($_POST['tambah_menu'])){
              ...
              //echo "<br>";
              //echo $nama_user . " || " . $username . " || " . $password .
              // " || " . $id_level . " || " . $status;
              //echo "<br></br>";
              $query_tambah_masakan = "insert into tb_masakan values 
            ...
            if(isset($_POST['ubah_menu'])){
              ...
              $query_ubah_masakan = "update tb_masakan set nama_masakan = '$nama_masakan', harga = '$harga', 
                                    stok = '$stok', status_masakan = '$status_masakan' where id_masakan = '$id_masakan'";
