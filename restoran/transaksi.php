  ...
  <div class="container-fluid">
    ...
    <?php
      if($r['id_level'] == 1){
        ...
        $query_pemesan = "select * from tb_order left join tb_user on tb_order.id_pengunjung 
                        = tb_user.id_user where id_order = $id_order";
    ...
    ?>
          ...
          <div class="widget-content nopadding" >
            <table class="table table-bordered table-invoice-full">
              ...
              <tbody>
                <?php
                  $no_order_fiks = 1;
                  $query_order_fiks = "select * from tb_pesan left join tb_masakan on tb_pesan.id_masakan = 
                                      tb_masakan.id_masakan where id_user = $id_pemesan and status_pesan != 'sudah'";
      ...
      <?php
          ...
          if(isset($_REQUEST['save_order'])){
            ...
            $query_save_transaksi = "update tb_order set id_admin = $id, uang_bayar = $uang_bayar, 
                                    uang_kembali = $uang_kembali, status_order = 'sudah bayar' where id_order = $id_order";
            echo $query_save_transaksi;
            $sql_save_transaksi = mysqli_query($conn, $query_save_transaksi);

            $query_selesai_pesan = "update tb_pesan set status_pesan = 'sudah' 
                                    where id_user = $id_pemesan and status_pesan != 'sudah'";
