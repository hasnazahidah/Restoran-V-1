        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding" >
            <table class="table table-bordered table-invoice-full">
              ...
              <tbody>
                <?php
                  $query_order = "select * from tb_order left join tb_user on tb_order.id_pengunjung = 
                                  tb_user.id_user where status_order = 'belum bayar'";
          ...
          <div class="widget-content nopadding" >
            <table class="table table-bordered table-invoice-full">
              ...
              <tbody>
                <?php
                  $nomor = 1;
                  $query_sudah_order = "select * from tb_order left join tb_user on tb_order.id_pengunjung = 
                                        tb_user.id_user where status_order = 'sudah bayar' order by id_order desc";
                ...
                <tr>
                  ...
                  <td>
                    <form action="" method="post">
                      ...
                      <a target='_blank' href="cetak_transaksi.php?konten=<?php echo $r_sudah_order['id_order'];?>" 
