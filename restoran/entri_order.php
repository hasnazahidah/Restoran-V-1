    ...
    <div class="row-fluid">
      ...
      <?php
          ...
          if(isset($_POST['proses_pesan'])){
            ...
            $time = Date('YmdHis');
            echo $time;
            $query_simpan_order = "insert into tb_order values('', '$id_admin', '$id_pengunjung', $time, '$no_meja',
                                                    '$total_harga', '$uang_bayar', '$uang_kembali', '$status_order')";
            ...
            $query_ubah_jumlah = "select * from tb_pesan left join tb_masakan on tb_pesan.id_masakan = 
                                  tb_masakan.id_masakan where id_user = $id and status_pesan != 'sudah'";
            ...
            while($r_ubah_jumlah = mysqli_fetch_array($sql_ubah_jumlah)){
              ...
              //echo $tempe;
              $query_proses_ubah = "update tb_pesan set jumlah = $tempe, id_order = $id_ordernya where id_masakan = 
                                    $tahu and id_user = $id and status_pesan != 'sudah'";
